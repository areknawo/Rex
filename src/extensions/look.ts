...
export interface LookAroundExtension {
   ...
   */
  follow(expr: string | FuncExpr<Matcher>): Matcher
  after: LookAroundExtension['follow']
  /**
   ...
   */
  precede(expr: string | FuncExpr<Matcher>): Matcher
  before: LookAroundExtension['precede']
}

/**
 * RegEx look around methods ReX.js extension.
 */
export const LookAroundExtension: Method<Matcher>[] = [
  {
    name: ['follow', 'after'],
